    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Boglin layser", Description = "A butterknife, great for toast.", Force = 1, Image = null, Price = 10, Qty = 500, QtyBought = 0, CreatedDate = new DateTime(1999, 07, 03)}
            );
            #endregion
        }
    }
